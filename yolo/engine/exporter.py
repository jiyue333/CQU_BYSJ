...
from yolo.cfg import TASK2CALIBRATIONDATA, TASK2DATA, get_cfg
...
from yolo.nn.modules import C2f, Classify, Detect, RTDETRDecoder, Segment26
from yolo.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from yolo.utils import ARM64, DEFAULT_CFG, IS_DEBIAN_BOOKWORM, IS_DEBIAN_TRIXIE, IS_DOCKER, IS_RASPBERRYPI, IS_UBUNTU, LINUX, LOGGER, MACOS, MACOS_VERSION, RKNN_CHIPS, SETTINGS, TORCH_VERSION, WINDOWS, YAML, colorstr, get_default_args, is_dgx, is_jetson
...
from yolo.utils.nms import TorchNMS
from yolo.utils.ops import Profile
from yolo.utils.patches import arange_patch
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if fmt == "imx":
            from yolo.utils.export.imx import FXModel

            model = FXModel(model, self.imgsz)
        if fmt in {"tflite", "edgetpu"}:
            from yolo.utils.export.tensorflow import tf_wrapper

            model = tf_wrapper(model)
        if fmt == "executorch":
            from yolo.utils.export.executorch import executorch_wrapper
    ...
    def export_torchscript(self, prefix=colorstr("TorchScript:")):
        ...
        from yolo.utils.export.torchscript import torch2torchscript
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        from yolo.utils.export.engine import best_onnx_opset, torch2onnx
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        from yolo.utils.export import torch2openvino
    ...
    def export_paddle(self, prefix=colorstr("PaddlePaddle:")):
        ...
        from yolo.utils.export.paddle import torch2paddle
    ...
    def export_mnn(self, prefix=colorstr("MNN:")):
        ...
        from yolo.utils.export.mnn import onnx2mnn
    ...
    def export_ncnn(self, prefix=colorstr("NCNN:")):
        ...
        from yolo.utils.export.ncnn import torch2ncnn
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        from yolo.utils.export.coreml import IOSDetectModel, pipeline_coreml, torch2coreml
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        from yolo.utils.export.engine import onnx2engine
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        from yolo.utils.export.tensorflow import onnx2saved_model
    ...
    def export_pb(self, keras_model, prefix=colorstr("TensorFlow GraphDef:")):
        ...
        from yolo.utils.export.tensorflow import keras2pb
    ...
    def export_axelera(self, prefix=colorstr("Axelera:")):
        ...
        from yolo.utils.export.axelera import torch2axelera
    ...
    def export_executorch(self, prefix=colorstr("ExecuTorch:")):
        ...
        check_executorch_requirements()
        from yolo.utils.export.executorch import torch2executorch
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        from yolo.utils.export.tensorflow import tflite2edgetpu
    ...
    def export_tfjs(self, prefix=colorstr("TensorFlow.js:")):
        ...
        from yolo.utils.export.tensorflow import pb2tfjs
    ...
    def export_rknn(self, prefix=colorstr("RKNN:")):
        ...
        from yolo.utils.export.rknn import onnx2rknn
    ...
    def export_imx(self, prefix=colorstr("IMX:")):
        ...
        from yolo.utils.export.imx import torch2imx
