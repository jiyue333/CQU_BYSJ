...
from yolo.utils import ENVIRONMENT, GIT, LOGGER, PYTHON_VERSION, RANK, SETTINGS, TESTS_RUNNING, Retry, colorstr
...
try:
    ...
    from yolo.utils.logger import ConsoleLogger, SystemLogger
...
def _upload_model(model_path, project, name, progress=False, retry=1, model_id=None):
    ...
    from yolo.utils.uploads import safe_upload
