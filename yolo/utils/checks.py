...
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    ...
    if (
        ...
        from yolo.utils.callbacks.platform import resolve_platform_uri
