...
from yolo.data.utils import IMG_FORMATS
from yolo.utils import LOGGER, TORCH_VERSION
from yolo.utils.checks import check_requirements
from yolo.utils.torch_utils import TORCH_2_4, select_device
...
class VisualAISearch:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if not self.data_dir.exists():
            from yolo.utils import ASSETS_URL
