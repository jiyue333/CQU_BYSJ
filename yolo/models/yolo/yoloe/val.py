...
from yolo.data import YOLOConcatDataset, build_dataloader, build_yolo_dataset
...
from yolo.models.yolo.segment import SegmentationValidator
from yolo.nn.modules.head import YOLOEDetect
    ...
    def __call__(
        ...
        if trainer is not None:
            ...
            if isinstance(model, (str, Path)):
                from yolo.nn.tasks import load_checkpoint
