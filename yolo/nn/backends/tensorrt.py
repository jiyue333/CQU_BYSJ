...
from yolo.utils import IS_JETSON, LINUX, LOGGER, PYTHON_VERSION
from yolo.utils.checks import check_requirements, check_version
...
class TensorRTBackend(BaseBackend):
    ...
    def load_model(self, weight: str | Path) -> None:
        ...
        try:
            import yolo.nn.backends.tensorrt as trt
        except ImportError:
            if LINUX:
